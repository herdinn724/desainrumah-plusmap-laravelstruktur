...
<html lang="en">
  ...
  <head>
    ...
    <title>Desain Rumah Berau</title>
...
<body>
            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text">
                  <h2>General <em>Design</em> &<br>  <em>building Design</em></h2>
                  <div class="div-dec"></div>
                  <p>we are designers for construction and architecture (berau, east borneo)</p>
                  <div class="buttons">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="service-item">
            ...
            <h4>Flexible</h4>
            <p>Bisa berkonsultasi kapan saja & dimana saja.</p>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="service-item">
            ...
            <p>Bisa diakses untuk menampilkan desain yang responsive segala perangkat (handphone, tablet dan komputer).</p>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="service-item">
            ...
            <h4>Affordable</h4>
            <p>Desain menyesuaikan budget customer.</p>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="service-item">
            ...
            <p>Fast respon untuk customer.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="simple-cta">
    <div class="container">
      <div class="row">
        <div class="col-lg-5">
          <h4>Harga <em>mulai</em> 30 K<strong></strong> /meter</h4>
        </div>
        <div class="col-lg-7">
          <div class="buttons">
            <div class="green-button">
      ...
      <div class="row">
          ...
          <div class="naccs">
            <div class="tabs">
              <div class="row">
                <div class="col-lg-12">
                  <div class="menu">
                    <div class="active gradient-border"><span>Biaya Desain</span></div>
                  </div>
                </div>
                <div class="col-lg-12">
                  <ul class="nacc">
                    <li class="active">
                      <div>
                        ...
                        <div class="list-item">
                          <span class="item item-title">3D Design + Rendering</span>
                          <span class="item">10.000 /Meter</span>
                        </div>
                        <div class="list-item">
                          <span class="item item-title">2D Design + Design (Gambar Kerja)</span>
                          <span class="item">20.000 /Meter</span>
                        </div>
                        <div class="list-item">
                          <span class="item item-title">RAB (Rancangan Anggaran Biaya)</span>
                          <span class="item">10.000 /Meter</span>
                        </div>
                        <div class="list-item last-item">
                          <span class="item item-title">All In (2D/3D/4D)</span>
                          <span class="item">35.000-40.000 /Meter</span>
                      </div>
                    </li>
                  </ul>
                </div>
        ...
        <div class="col-lg-4">
          <div class="right-content">
            ...
            <p>untuk harga akan menyesuaikan dengan tingkat kesulitan dan beberapa pertimbangan atas kesepakatan dengan client untuk harga akan menyesuaikan dengan tingkat kesulitan dan beberapa pertimbangan atas kesepakatan dengan client dan free revisi 3x.</p>
            <div class="green-button">
